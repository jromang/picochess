...
nf3check = [
    AudioSegment.from_wav('voices/en/al/wav/knight.wav'),
    AudioSegment.from_wav('voices/en/al/wav/f.wav'),
    AudioSegment.from_wav('voices/en/al/wav/3.wav'),
    AudioSegment.from_wav('voices/en/al/wav/check.wav')
]
