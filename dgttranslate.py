...
class DgtTranslate(object):
    ...
    def text(self, text_id, msg=''):
        ...
        if text_id == 'B10_oktime':
            ...
            nl = Dgt.DISPLAY_TEXT(l='tijd ok', m='tijd ok', s='oktijd', beep=self.bl(BeepLevel.BUTTON), duration=1)
        ...
        if text_id == 'B10_okbeep':
            ...
            de = Dgt.DISPLAY_TEXT(l='Toene okay', m='Toene ok', s='ok ton', beep=self.bl(BeepLevel.BUTTON), duration=1)
        ...
        if text_id == 'B10_oklang':
            ...
            de = Dgt.DISPLAY_TEXT(l='Sprache okay', m='okSprache', s='ok spr', beep=self.bl(BeepLevel.BUTTON), duration=1)
