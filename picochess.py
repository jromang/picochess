...
def main():
    ...
    engine_opt, engine_idx = get_engine_level_dict(args.engine_level)
    ...
    DisplayMsg.show(Message.ENGINE_STARTUP(shell=engine.get_shell(), file=engine.get_file(), engine_index=engine_idx,
