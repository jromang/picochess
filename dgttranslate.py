...
class DgtTranslate(object):
    ...
    def text(self, text_id, msg=''):
        ...
        if text_id == 'Y00_erroreng':
            ...
            es = Dgt.DISPLAY_TEXT(l='err motor', m='errmotor', s='errmot', beep=self.bl(BeepLevel.YES), duration=0)
        if text_id == 'B10_okengine':
            ...
            es = Dgt.DISPLAY_TEXT(l='okay motor', m='ok motor', s='ok mot', beep=self.bl(BeepLevel.BUTTON), duration=1)
        if text_id == 'B10_okmode':
            ...
            es = Dgt.DISPLAY_TEXT(l='okay modo', m='ok modo', s='okmodo', beep=self.bl(BeepLevel.BUTTON), duration=1)
        if text_id == 'B10_oklevel':
            ...
            es = Dgt.DISPLAY_TEXT(l='okay nivel', m='ok nivel', s='ok nvl', beep=self.bl(BeepLevel.BUTTON), duration=1)
        ...
        if text_id == 'B10_okbook':
            ...
            es = Dgt.DISPLAY_TEXT(l='okay libro', m='ok libro', s='oklibr', beep=self.bl(BeepLevel.BUTTON), duration=1)
        ...
        if text_id == 'B10_oktime':
            ...
            es = Dgt.DISPLAY_TEXT(l='okay tiempo', m='ok tiempo', s='oktime', beep=self.bl(BeepLevel.BUTTON), duration=1)
        ...
        if text_id == 'K05_okuser':
            ...
            es = Dgt.DISPLAY_TEXT(l="okay usuario", m="okusuari", s="okuser", beep=self.bl(BeepLevel.OKAY), duration=0.5)
        if text_id == 'K05_okmove':
            ...
            es = Dgt.DISPLAY_TEXT(l="okay jugada", m="ok jugada", s="ok jug", beep=self.bl(BeepLevel.OKAY), duration=0.5)
        ...
        if text_id == 'B10_playmode_white_user':
            ...
            es = Dgt.DISPLAY_TEXT(l=None, m='blancas', s='blanca', beep=self.bl(BeepLevel.CONFIG), duration=1)
        if text_id == 'B10_playmode_black_user':
            ...
            es = Dgt.DISPLAY_TEXT(l=None, m='negras', s=None, beep=self.bl(BeepLevel.CONFIG), duration=1)
