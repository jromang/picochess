...
class DgtBoard(object):
    ...
    def __init__(self, device: str, disable_revelation_leds: bool, is_pi: bool, capital_letters: bool):
    ...
    def write_command(self, message: list):
        ...
        char_to_xl = {
            ...
            'u': 0x3e, 'v': 0x2a, 'w': 0x6a, 'x': 0x49, 'y': 0x6e, 'z': 0x5b, ' ': 0x00, '-': 0x40, '/': 0x52, '|': 0x36,
