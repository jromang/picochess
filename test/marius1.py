    ...
    def process_message(self, message_id, message):
        for case in switch(message_id):
            ...
            if case(Messages.DGT_MSG_BWTIME):
                ...
                # Marius: This is AGAINST the document - i guess done with reverse engineering.
                # How to find a button press? Is it possible to find button press of 2,3 buttons pressed together?!?
